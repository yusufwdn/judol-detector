...
Catatan setiap perubahan dataset: tanggal, jumlah data, sumbernya, dan dampaknya
pada hasil evaluasi. Dipakai untuk melacak versi mana yang menghasilkan angka
tertentu.

Untuk gambaran dataset saat ini, lihat [dataset.md](dataset.md).
...
[eksperimen.md](eksperimen.md#aturan-heuristik-tambahan)).
...
ablation study (lihat [eksperimen.md](eksperimen.md#aturan-heuristik-tambahan)); (2) error analysis
