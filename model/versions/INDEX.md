...
| 12 | [`v12/`](v12/) | *(belum di-commit)* | 2026-06-30 | 2332 / 4177 / 6509 | 8006 | 97.39% (hard test set: 97.04%) | 61 entri kontaminasi (3 kampanye spam tersamar: Mantulhoki, Hoki777, 4rabet/Anru33 — termasuk 8 yang sudah ada sejak sebelum sesi ini) direlabel dari non_spam ke spam, bukan sekadar dihapus. Akurasi turun dari v11 secara sengaja — v11 sebagian menghafal label salah. Sanity check: brand yang dibersihkan sekarang terdeteksi spam 99.6–100%. Detail di [`DATASET_LOG.md` Versi 11](../../DATASET_LOG.md#versi-11--2026-06-30). |
| 13 | [`v13/`](v13/) | *(belum di-commit)* | 2026-06-30 | 2332 / 4358 / 6690 | 8342 | 97.46% (hard test set: 98.52%, rekor tertinggi) | Scrape ulang 2 video relevan dengan `order=time` + `TARGET_COUNT` lebih tinggi (bukan video baru) untuk menyisir dead zone scraper (skor 10-29) yang biasa dibuang. 181 komentar non-spam bertema judi ditemukan dan ditambahkan. Kasus FN "PBB4D" kini benar masuk training tapi model TETAP salah (99.18% spam) — bukti empiris keterbatasan struktural SVM linear, bukan kurang data. Detail di [`DATASET_LOG.md` Versi 12](../../DATASET_LOG.md#versi-12--2026-06-30). |
