"""Dump entri final_spam.json yang tidak masuk dataset beserta alasannya.

Dipakai untuk meninjau manual apakah ada spam yang keliru terbuang.

    python src/inspect_skipped.py

Hasilnya ditulis ke data/skipped_entries.json.
"""
